...
from climfill.feature_engineering import create_embedded_feature,  create_time_feature, stack_constant_maps
...
def climfill(data, constant_maps):
    # load your data
    print("load data ...")
    ...
    varnames = [i for i in data.data_vars]
    print(varnames)
...
if __name__=="__main__":
    ...
    product_dir = config['PRECIP']['ERA5']['path']
    ...
    precp_ds = precp_ds.rename({variable:"variable"})
    print(precp_ds)
    climfill(precp_ds, constant_maps)