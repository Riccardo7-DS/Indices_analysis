from analysis import summarize_metric_across_horizons, compute_ensable_rmse, compute_ssr, tensor_ssim
import argparse, os
...
save_path = "./output/images"  # Specify the path where you want to save the metrics
metric, funct = "RMSE", compute_ensable_rmse  # or "mbe", "rmse", etc.
summarize_metric_across_horizons(funct, args.eta, args.num_ensambles, metric, day_list=args.days, save_path=save_path)
